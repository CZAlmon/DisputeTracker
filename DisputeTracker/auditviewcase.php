...
$PageTitle = "Dispute Track - Audit View Dispute";
...
?>
			...
			<div class="row">
				...
				<!-- 2 Buttons, One to go back to view disputes without editing the Case and one to Delete the Case and All Transactions -->
					<a href="AuditViewDisputes.php" class="btn btn-success form-control">View Disputes</a>
				</div>
				<!--
				<div class="col-md-3">
