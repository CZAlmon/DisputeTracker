...
for($i=$DisputeCount-1; $i >= 0; $i--){
	...
	print "<td><form method='post' action='auditviewcase.php'><button type='submit' name='ViewSubmit' value='".$AllDisputesArray[$i][0]."' class='fa fa-external-link-square btn btn-primary'></button></form></td>";
