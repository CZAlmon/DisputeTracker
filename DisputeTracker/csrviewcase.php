...
if($ViewCaseID == 0 || $ViewCaseID == NULL){
	...
	echo '<script> window.location = "CSRViewDisputes.php";</script>';
...
?>
			...
			<div class="row">
				...
				<!-- 2 Buttons, One to go back to view disputes without editing the Case and one to Delete the Case and All Transactions -->
					<a href="CSRViewDisputes.php" class="btn btn-success form-control">View Disputes</a>
				</div>
				<div class="col-md-2">
					<label>Add Attachments</label>
					<a href="addAttachments.php" class="btn btn-primary form-control">Add Attachments</a>
				</div>
				<!--
				<div class="col-md-2">
